...
function Appbar({ openSidebar }) {
  return (
    <div className="flex justify-between items-center px-3 mt-5 ">
      <button onClick={openSidebar} className="lg:hidden  mr-4 border border-gray-300 rounded-full p-1 font-bold">
      <RxTextAlignJustify  className="text-sm" />
      </button>
