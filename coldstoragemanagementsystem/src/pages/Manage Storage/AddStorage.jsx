...
return(
  ...
  <div className="text-xl border-b border-gray-100  pb-4 mb-4">
    <h1 className="text-lg font-semibold">Add Storage</h1>
  </div>
  <form action="">
  <div className="flex flex-col space-y-6">
  <div className="flex items-center justify-between">
    <label className="text-sm text-gray-500">Storage Name</label>
    <input
      type="text"
  ...
  <div className="flex items-center justify-between">
    <label className="text-sm text-gray-500">Storage Code</label>
    <input
      type="number"
  ...
  <div className="flex items-center justify-between">
    <label className="text-sm text-gray-500">Storage Quantity</label>
    <input
      type="text"
